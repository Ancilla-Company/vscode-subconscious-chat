...
export const buildRemoteIndexCommandId = 'subconscious.buildRemoteWorkspaceIndex';
export const deleteExternalIngestWorkspaceIndexCommandId = 'subconscious.deleteExternalIngestWorkspaceIndex';
...
export function register(accessor: ServicesAccessor): IDisposable {
	...
	disposableStore.add(vscode.commands.registerCommand('subconscious.debug.collectWorkspaceIndexDiagnostics', async () => {
