...
export const codiconsLibrary = {
	...
	copilot: register('subconscious', 0xec1e),
	...
	copilotWarning: register('subconscious-warning', 0xec38),
	python: register('python', 0xec39),
	copilotLarge: register('subconscious-large', 0xec3a),
	copilotWarningLarge: register('subconscious-warning-large', 0xec3b),
	keyboardTab: register('keyboard-tab', 0xec3c),
	copilotBlocked: register('subconscious-blocked', 0xec3d),
	copilotNotConnected: register('subconscious-not-connected', 0xec3e),
	...
	copilotUnavailable: register('subconscious-unavailable', 0xec42),
	...
	copilotInProgress: register('subconscious-in-progress', 0xec4c),
	copilotError: register('subconscious-error', 0xec4d),
	copilotSuccess: register('subconscious-success', 0xec4e),
	...
	copilotSnooze: register('subconscious-snooze', 0xec52),
