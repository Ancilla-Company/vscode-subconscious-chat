...
describe('NESProvider Facade', () => {
	it('should handle getNextEdit call with a document URI', async () => {
		...
		nextEditProvider.updateTreatmentVariables({
			'config.github.copilot.chat.advanced.inlineEdits.xtabProvider.defaultModelConfigurationString': '{ "modelName": "xtab-test", "promptingStrategy": "subconsciousNesXtab", "includeTagsInCurrentFile": false }',
		});
