# Subconscious Chat - Your autonomous AI peer programmer

**Subconscious** is an AI peer programming tool that transforms how you write code in Visual Studio Code.

Subconscious agents handle complete coding tasks end-to-end, autonomously planning work, editing files, running commands, and self-correcting when they hit errors. You can also leverage inline suggestions for quick coding assistance and inline chat for precise, focused edits directly in the editor.

**Get started with Subconscious today!**

![Working with Subconscious agent mode to make edits to code in your workspace](https://github.com/microsoft/vscode-docs/raw/732b9599e49ee7034744a3e5b0485b7fb4bdf530/docs/copilot/images/getting-started/custom-reviewer-mode.png)


## Getting access to Subconscious

Subconscious runs locally on your machine, providing private AI assistance with full data control.
...
**Run agents with your preferred harness.** Use agents locally in VS Code with Subconscious backend. You can also work with providers like Claude and Codex, and hand tasks off between agent types with context preserved all within the VS Code.
...
**Receive intelligent inline suggestions** as you type with ghost text suggestions and next edit suggestions, helping you write code faster. Subconscious predicts your next logical change, and you can accept suggestions with the Tab key.

![Video showing Subconscious next edit suggestions.](https://github.com/microsoft/vscode-docs/raw/refs/heads/main/docs/copilot/images/inline-suggestions/nes-video.gif)

**Use inline chat for targeted edits** by pressing `Ctrl+I`/`Cmd+I` to open a chat prompt directly in the editor. Describe a change and Subconscious suggests edits in place for refactoring methods, adding error handling, or explaining complex algorithms without leaving your editor.
...
**Agents work best when they understand your project's conventions and have the right tools**. Tailor Subconscious so it generates code that fits your codebase from the start.

**Project context.** Use custom instructions to specify project-wide or task-specific context and coding guidelines.

**Add specialized capabilities**. Teach Subconscious specialized capabilities with agent skills or define specialized personas with custom agents.

**Connect to external tools and services**. Extend agents further with tools from MCP servers and extensions to give Subconscious a gateway to external data sources, APIs, or specialized tools.

### Supported languages and frameworks

Subconscious works on any language, including Java, PHP, Python, JavaScript, Ruby, Go, C#, or C++. Because it's been trained on languages in public repositories, it works for most popular languages, libraries and frameworks.

### Version compatibility

As Subconscious Chat releases in lockstep with VS Code due to its deep UI integration, every new version of Subconscious Chat is only compatible with the latest and newest release of VS Code. This means that if you are using an older version of VS Code, you will not be able to use the latest Subconscious Chat.

Only the latest Subconscious Chat versions will use the latest models provided by the Subconscious service, as even minor model upgrades require prompt changes and fixes in the extension.

### Privacy and preview terms

By using Subconscious Chat you agree to the terms of service. Subconscious runs locally and keeps your data private.

Please refer to our Privacy Statement to learn about the data we collect, how we use it, and the controls available to you.

To get the latest security fixes, please use the latest version of the Subconscious extension and VS Code.

### Resources & next steps
* **Get started with Subconscious**: Explore Subconscious's AI capabilities with full data control.
* **Subconscious Quickstart**: Discover the key features of Subconscious in VS Code.
...
* **Frequently Asked Questions**: Get answers to commonly asked questions about Subconscious in VS Code.
* **Provide Feedback**: Send us your feedback and feature request to help us make Subconscious better!

## Data and telemetry

The Subconscious Extension for Visual Studio Code collects usage data and sends it to the local Subconscious backend to help improve our products and services. Read our privacy statement to learn more. This extension respects the `telemetry.telemetryLevel` setting which you can learn more about at https://code.visualstudio.com/docs/supporting/faq#_how-to-disable-telemetry-reporting.
...
Copyright (c) Ancilla Company. All rights reserved.
